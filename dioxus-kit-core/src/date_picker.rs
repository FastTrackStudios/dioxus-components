...
/// ```rust
/// use dioxus::prelude::*;
/// use dioxus_kit_core::{calendar::Calendar, date_picker::*, popover::*, ContentAlign};
/// use time::Date;
/// #[component]
/// fn Demo() -> Element {
...
/// ```rust
/// use dioxus::prelude::*;
/// use dioxus_kit_core::{calendar::{DateRange, RangeCalendar}, date_picker::*, popover::*, ContentAlign};
/// #[component]
/// fn Demo() -> Element {
