...
use crate::tooltip::{Tooltip, TooltipContent, TooltipTrigger};
use dioxus::core::use_drop;
use dioxus::prelude::*;
use dioxus_icons::lucide::PanelLeft;
use dioxus_kit_core::dioxus_attributes::attributes;
use dioxus_kit_core::merge_attributes;
use dioxus_kit_core::use_controlled;

#[css_module("/src/sidebar/style.css")]
struct Styles;
        ...
        Tooltip {
            ...
            TooltipContent {
                side: match sidebar_side() {
                    SidebarSide::Left => dioxus_kit_core::ContentSide::Right,
                    SidebarSide::Right => dioxus_kit_core::ContentSide::Left,
                },
                {tooltip_content}
            }
        }
